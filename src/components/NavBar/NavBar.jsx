        ...
        <Navbar color="white" light expand="md">
          ...
          <Collapse isOpen={isOpen} navbar>
            <Nav className="mr-auto" navbar>
              <NavItem>
                <NavLink className="headernavlink" href="/program">
                  ALL PROGRAM
                </NavLink>
              </NavItem>
              <NavItem>
                <NavLink className="headernavlink" href="/reward">
                  REWARD
                </NavLink>
              </NavItem>
              ...
              <div>
                ...
                <a href="/program">
                  <button
                    ...
                    onClick={() =>
                      localStorage.setItem("search", search.searchInput)
                    }
                  >
                    <FaSearch />
                  </button>
        ...
        props.User.isLogin && props.User.role == 1 ? (
          <div className="headermenu-containerislogin">
            <div className="headermenu-item">
              <a href="/collection-programs" style={{ color: "inherit" }}>
                PROFILE
              </a>
            </div>
            <div className="headermenu-item">
              <a href="/" style={{ color: "inherit" }} onClick={onClickSignOut}>
                SIGN OUT
              </a>
            </div>
            <div className="headermenu-itemlast">
              <a href={"/cart/" + props.User.id} style={{ color: "inherit" }}>
                <FaHandHoldingHeart className="holdingheart" />
                CART
              </a>
            </div>
          </div>
